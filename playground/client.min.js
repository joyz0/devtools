            ...
            !(function (e) {
              ...
              void 0 !== r.Reflect && (o = a(r.Reflect, o)),
                (function (t, e) {
                  var n = Object.prototype.hasOwnProperty,
                    ...
                    d =
                      ...
                      'function' == typeof Set.prototype.entries
                        ? Set
                        : lt(),
                    p = 'function' == typeof WeakMap ? WeakMap : ft(),
                  ...
                  function R(t, e, n) {
                    if (k(t, e, n)) return j(t, e, n)
                    var r = rt(e)
                    return B(r) ? void 0 : R(t, r, n)
                  }
                  function j(t, e, n) {
                    var r = ut(e, n, !1)
    ...
    return (
      (function () {
        ...
        var w = (function () {
          ...
          m = 'Metadata key was used more than once in a parameter:',
          T = 'NULL argument',
          x = 'Key Not Found',
          O = 'Ambiguous match found for serviceIdentifier:',
          A = 'No matching bindings found for serviceIdentifier:',
          M = 'Missing required @injectable annotation in:',
          E =
          ...
          P = 'multi_inject',
          N = 'inversify:tagged',
          C = 'inversify:tagged_props',
          F = 'inversify:paramtypes',
          W = 'post_construct',
          B = 'pre_destroy'
        var L = [j, P, D, k, S, R],
          H = (function () {
            ...
            return (
              (t.prototype.getConstructorMetadata = function (t) {
                return {
                  compilerGeneratedMetadata: Reflect.getMetadata(F, t),
                  userGeneratedMetadata: Reflect.getMetadata(N, t) || {},
                }
              }),
              (t.prototype.getPropertiesMetadata = function (t) {
                return Reflect.getMetadata(C, t) || []
              }),
              t
            )
          })(),
          ...
          return (
            0 !== i.length &&
              ...
              i.forEach(function (t) {
                var e = 'Object'
                null !== t.implementationType && (e = X(t.implementationType)),
                  (r = r + '\n ' + e),
        ...
        function U(t, e) {
          return (
            ...
            (t.parentRequest.serviceIdentifier === e || U(t.parentRequest, e))
          )
        }
        function Y(t) {
          t.childRequests.forEach(function (t) {
            if (U(t, t.serviceIdentifier)) {
              var e = (function (t) {
                var e = (function t(e, n) {
                  void 0 === n && (n = [])
                  var r = V(e.serviceIdentifier)
                  return (
                    n.push(r),
        ...
        function rt(t, e, n, r) {
          ...
          if (void 0 === o) throw new Error(M + ' ' + e + '.')
        ...
        function it(t, e, n, r, i) {
          ...
          if (((u = c || u) instanceof $ && (u = u.unwrap()), s)) {
        ...
        function ot(t, e, n, r) {
          var i = t || e
          if (void 0 === i) {
            var o = M + ' for property ' + String(n) + ' in class ' + r + '.'
            throw new Error(o)
          }
          return i
        }
        function at(t, e, n) {
          for (
            ...
            var u = s[a],
              ...
              l = ut(c),
              f = l.targetName || u,
              h = ot(l.inject, l.multiInject, u, n),
              d = new et(y, f, h)
            ;(d.metadata = c), i.push(d)
          }
        ...
        function ft(t, e, n, r, i) {
          var o = dt(n.container, i.serviceIdentifier),
            a = []
          return (
            o.length === z &&
              ...
              (o = dt(n.container, i.serviceIdentifier))),
            (a = e
              ? o
              : o.filter(function (t) {
                  var e = new ct(t.serviceIdentifier, n, r, t, i)
        ...
        function ht(t, e, n, r, i, o) {
          var a, s
          if (null === i) {
            ;(a = ft(t, e, r, null, o)), (s = new ct(n, r, null, a, o))
            var u = new J(r, s)
            r.addPlan(u)
          } else
            (a = ft(t, e, r, i, o)),
          ...
          a.forEach(function (e) {
            ...
            if (e.type === h && null !== e.implementationType) {
              ...
              if (!r.container.options.skipBaseClassChecks) {
                var a = st(t, e.implementationType)
                if (i.length < a) {
                  var u = (function () {
                  ...
                  })(X(e.implementationType))
                  throw new Error(u)
                }
              }
              i.forEach(function (e) {
                ht(t, !1, e.serviceIdentifier, r, n, e)
              })
            }
          })
        }
        function dt(t, e) {
          ...
          return (
            r.hasKey(e)
              ? (n = r.get(e))
              : null !== t.parent && (n = dt(t.parent, e)),
            n
          )
        }
        function pt(t, e, n, r, i, o, a, s) {
          void 0 === s && (s = !1)
          var u = new Q(e),
          ...
          try {
            return ht(t, s, i, u, null, c), u
          } catch (t) {
            throw (q(t) && Y(u.plan.rootRequest), t)
          }
        }
        function yt(t) {
          return (
        ...
        function vt(t) {
          return !!yt(t) || (Array.isArray(t) && t.some(yt))
        }
        var gt,
          _t = function (t, e, n, r) {
          ...
          mt = function (t, e) {
            ;(t.cache = e), (t.activated = !0), yt(e) && Tt(t, e)
          },
          Tt = function (t, e) {
              ...
              ? (function (t) {
                  return Ot(this, void 0, void 0, function () {
                    ...
                    return At(this, function (r) {
                      switch (r.label) {
                        case 0:
                          return [4, St(t.constructorInjections)]
                        case 1:
                          return (e = r.sent()), [4, St(t.propertyInjections)]
                        case 2:
                          return (
                            (n = r.sent()),
                            [
        ...
        function It(t) {
          var e,
            n = new ((e = t.constr).bind.apply(
              e,
              Mt([void 0], t.constructorInjections, !1),
            ))()
          return (
        ...
        function Dt(t, e) {
          var n = (function (t, e) {
            var n, r
            if (Reflect.hasMetadata(W, t)) {
              var i = Reflect.getMetadata(W, t)
              try {
          ...
          t.scope !== o &&
            (function (t, e) {
              ...
              if ('function' == typeof t.onDeactivation)
                throw new Error(I(e.name, n))
              if (Reflect.hasMetadata(B, e))
                throw new Error(
        ...
        var Rt = function (t, e, n, r) {
          ...
          Nt = function (t, e) {
            var n = (function (t) {
              switch (t.type) {
                case l:
                  return { factory: t.factory, factoryType: gt.Factory }
                case p:
                  return { factory: t.provider, factoryType: gt.Provider }
                case c:
                  return {
                    factory: t.dynamicValue,
                    factoryType: gt.DynamicValue,
                  }
                default:
              ...
              case h:
                r = (function (t, e, n, r) {
                  ...
                  return yt(i)
                    ...
                    : Dt(e, i)
                })(n, n.implementationType, i, Pt(t))
                break
              default:
                r = Nt(n, e.parentContext)
            }
            return r
          },
          Ft = function (t, e, n) {
            ...
            return (
              null !== r ||
                (function (t, e, n) {
                  e.scope === o && mt(e, n), e.scope === i && wt(t, e, n)
                })(t, e, (r = n())),
              r
            )
          },
          Wt = function (t, e, n) {
            return Ft(t, n, function () {
              var r = Ct(t, e, n)
              return (r = yt(r)
                ? r.then(function (t) {
                    return Bt(e, n, t)
        ...
        function Bt(t, e, n) {
          var r,
            i = Lt(t.parentContext, e, n),
            o = qt(t.parentContext.container),
            a = o.next()
          do {
            r = a.value
            var s = t.parentContext,
              ...
              c = Gt(r, u)
            ;(i = yt(i) ? zt(c, s, i) : Ht(c, s, i)), (a = o.next())
          } while (!0 !== a.done && !lt(r).hasKey(t.serviceIdentifier))
          return i
        }
        var Lt = function (t, e, n) {
          ...
          Ht = function (t, e, n) {
            for (var r = t.next(); !r.done; ) {
              if (yt((n = r.value(e, n)))) return zt(t, e, n)
              r = t.next()
            }
            return n
          },
        ...
        var Vt = function t(e, n) {
          ...
          Xt = (function () {
            ...
            return (
              (t.prototype.when = function (t) {
                return (this._binding.constraint = t), new Qt(this._binding)
              }),
              (t.prototype.whenTargetNamed = function (t) {
                return (this._binding.constraint = Ut(t)), new Qt(this._binding)
              }),
              ...
              (t.prototype.whenParentNamed = function (t) {
                return (
                  (this._binding.constraint = function (e) {
                    return null !== e && Ut(t)(e.parentRequest)
                  }),
                  new Qt(this._binding)
                )
              }),
              (t.prototype.whenParentTagged = function (t, e) {
                return (
                  (this._binding.constraint = function (n) {
                    return null !== n && Kt(t)(e)(n.parentRequest)
                  }),
                  new Qt(this._binding)
                )
              }),
          ...
          Qt = (function () {
            ...
            return (
              (t.prototype.onActivation = function (t) {
                return (this._binding.onActivation = t), new Xt(this._binding)
              }),
              (t.prototype.onDeactivation = function (t) {
                return (this._binding.onDeactivation = t), new Xt(this._binding)
              }),
              t
            )
          })(),
          Zt = (function () {
            function t(t) {
              ;(this._binding = t),
                (this._bindingWhenSyntax = new Xt(this._binding)),
                (this._bindingOnSyntax = new Qt(this._binding))
            }
            return (
              (t.prototype.when = function (t) {
          ...
          Jt = (function () {
            ...
            return (
              (t.prototype.inRequestScope = function () {
                return (this._binding.scope = i), new Zt(this._binding)
              }),
              (t.prototype.inSingletonScope = function () {
                return (this._binding.scope = o), new Zt(this._binding)
              }),
              (t.prototype.inTransientScope = function () {
                return (this._binding.scope = a), new Zt(this._binding)
              }),
              t
            )
          })(),
          $t = (function () {
            function t(t) {
              ;(this._binding = t),
                (this._bindingWhenSyntax = new Xt(this._binding)),
                (this._bindingOnSyntax = new Qt(this._binding)),
                (this._bindingInSyntax = new Jt(t))
            }
            return (
              (t.prototype.inRequestScope = function () {
        ...
        var ne = (function () {
            ...
            return (
              ...
              (t.prototype.remove = function (t) {
                if (null == t) throw new Error(T)
                if (!this._map.delete(t)) throw new Error(x)
              }),
          ...
          re = (function () {
            ...
            return (
              ...
              (t.prototype._getEmptyHandlersStore = function () {
                return { onActivations: new ne(), onDeactivations: new ne() }
              }),
              t
            )
          })(),
          ...
          ue = (function () {
            function t(t) {
              ...
              ;(this.options = {
                ...
                (this.id = b()),
                (this._bindingDictionary = new ne()),
                (this._snapshots = []),
                (this._middleware = null),
                (this._activations = new ne()),
                (this._deactivations = new ne()),
                (this.parent = null),
                (this._metadataReader = new H()),
                (this._moduleActivationStore = new re())
            }
            return (
              ...
              (t.prototype.bind = function (t) {
                var e = this.options.defaultScope || a,
                  n = new w(t, e)
                return this._bindingDictionary.add(t, n), new te(n)
              }),
                ...
                return oe(this, void 0, void 0, function () {
                  ...
                  return ae(this, function (n) {
                    switch (n.label) {
                      ...
                      case 1:
                        return (
                          n.sent(), (this._bindingDictionary = new ne()), [2]
                        )
                    }
                  })
                })
              ...
              (t.prototype.isBoundNamed = function (t, e) {
                return this.isBoundTagged(t, S, e)
              }),
              (t.prototype.isBoundTagged = function (t, e, n) {
                ...
                if (this._bindingDictionary.hasKey(t)) {
                  var i = this._bindingDictionary.get(t),
                    o = (function (t, e, n, r) {
                      var i = new et(g, '', e, new Z(n, r)),
                        o = new Q(t)
                      return new ct(e, o, null, [], i)
                    })(this, t, e, n)
                  r = i.some(function (t) {
              ...
              (t.prototype.getNamed = function (t, e) {
                return this.getTagged(t, S, e)
              }),
              (t.prototype.getNamedAsync = function (t, e) {
                return this.getTaggedAsync(t, S, e)
              }),
              ...
              (t.prototype.getAllNamed = function (t, e) {
                return this.getAllTagged(t, S, e)
              }),
              (t.prototype.getAllNamedAsync = function (t, e) {
                return this.getAllTaggedAsync(t, S, e)
              }),
              ...
              (t.prototype._preDestroy = function (t, e) {
                var n, r
                if (Reflect.hasMetadata(B, t))
                  return null ===
                    (r = (n = e)[Reflect.getMetadata(B, t).value]) ||
                    void 0 === r
                    ? void 0
                    : r.call(n)
              }),
              ...
              (t.prototype._deactivate = function (t, e) {
                ...
                try {
                  ...
                  if (yt(o)) return this._handleDeactivationError(o, r)
                } catch (t) {
                  if (t instanceof Error) throw new Error(I(r.name, t.message))
                }
              }),
                    ...
                    switch (r.label) {
                      ...
                      case 2:
                        if ((n = r.sent()) instanceof Error)
                          throw new Error(I(e.name, n.message))
                        return [3, 3]
                      case 3:
                        return [2]
                    }
              ...
              (t.prototype._planAndResolve = function () {
                ...
                return function (e) {
                  ...
                  return (function (t) {
                    return Pt(t.plan.rootRequest.requestScope)(
                      t.plan.rootRequest,
                    )
              ...
              (t.prototype._deactivateSingletons = function (t) {
                for (var e = 0, n = t; e < n.length; e++) {
                  var r = n[e]
                  if (yt(this._deactivateIfSingleton(r)))
                    throw new Error(
              ...
              (t.prototype._removeServiceFromDictionary = function (t) {
                try {
                  ...
                  throw new Error('Could not unbind serviceIdentifier: ' + V(t))
                }
              }),
        ...
        var Ee = (function () {
          function t() {
            pe()(this, t),
              Oe()(this, '_toDispose', new Set()),
              Oe()(this, '_isDisposed', !1)
          }
          return (
            ve()(t, [
              {
        ...
        Oe()(Ee, 'DISABLE_DISPOSED_WARNING', !1)
        var Ie = (function () {
            function t() {
              pe()(this, t), Oe()(this, '_store', new Ee())
            }
            return (
              ve()(t, [
                {
          ...
          Le = (function () {
            function t(e, n, r, i) {
              pe()(this, t),
                Oe()(this, '_handler', void 0),
                Oe()(this, '_node', void 0),
                Oe()(this, '_type', void 0),
                Oe()(this, '_options', void 0),
                (this._node = e),
                (this._type = n),
                (this._handler = r),
                (this._options = i || !1),
            ...
            return (
              ve()(n, [
                ...
                },
                {
                  key: 'dispose',
                  value: function () {
                    De()(Re()(n.prototype), 'dispose', this).call(this),
                      ...
                      (ze = (function (t) {
                        ...
                        function n() {
                          ...
                          return (
                            pe()(this, n),
                            (t = e.call(this)),
                            Oe()(_e()(t), 'behaviorMap', new Map()),
                            Oe()(_e()(t), 'dragElement', void 0),
                            Oe()(_e()(t), 'mouseMotionVector', void 0),
                            Oe()(_e()(t), 'lastMouseX', 0),
                            Oe()(_e()(t), 'lastMouseY', 0),
                            t._register(
                              He(document, Pe, function (e) {
                                e.preventDefault(), t._onDragEnd(e)
                              }),
                            ),
                            t._register(
                              He(document, Fe, function (e) {
                                e.preventDefault(), t._onDragEnd(e)
                              }),
                            ),
                            t._register(
                              He(document, Ce, function (e) {
                                e.preventDefault(), t._onDragging(e)
                              }),
                            ),
                            t._register(
                              He(window, Be, function (e) {
        ...
        function Ue(t) {
          ...
          if (Array.isArray(t)) {
            ...
            if (void 0 !== n) throw new Error(m + ' ' + n.toString())
          } else e = [t]
          return e
        }
        function Ye(t, e, n, r) {
            ...
            for (
              var s = function (t) {
                  if (
                    ...
                    throw new Error(m + ' ' + t.key.toString())
                },
                u = 0,
                c = a;
              u < c.length;
        ...
        function Xe(t) {
          return function (e, n, r) {
            'number' == typeof r
              ? Ke(e, n, r, t)
              : (function (t, e, n) {
                  if (void 0 !== t.prototype) throw new Error(E)
                  Ye(C, t.constructor, e, n)
                })(e, n, t)
          }
        }
        var Qe,
          ...
          nn =
            ...
            function (t) {
              return function (e, n, r) {
                if (void 0 === t) {
                  var i = 'function' == typeof e ? e.name : e.constructor.name
                  throw new Error(
          ...
          an =
            Ae()(
              (Ze =
                (function (t, e) {
                  return nn(rn.DraggableService)(t, void 0, 0)
                })(
                  (Ze =
                    Reflect.metadata(
                      'design:type',
                          ...
                          (Ze = (function (t) {
                            ...
                            function n(t) {
                              ...
                              return (
                                pe()(this, n),
                                (r = e.call(this)),
                                Oe()(_e()(r), '_options', void 0),
                                Oe()(_e()(r), 'offsetX', 0),
                                Oe()(_e()(r), 'offsetY', 0),
                                Oe()(_e()(r), '_panelPosition', void 0),
                                Oe()(_e()(r), '_panelElement', void 0),
                                Oe()(_e()(r), '_glowingElement', void 0),
                                Oe()(_e()(r), '_openInspector', !1),
                              ...
                              ve()(n, [
                                ...
                                },
                                {
                                  ...
                                  value: function () {
                                    ...
                                    return (
                                      this._draggableService.initialize(
                                        this._element,
                                        {
                                          onDragEnd: function () {
                                            ;(t.offsetX = 0),
                                          ...
                                          onWindowResize: function () {
                                            var e,
                                              ...
                                              a = Number(
                                                t._element.style.left.slice(
                                                  0,
                                                  -2,
                                                ),
                                              ),
                                              s = Number(
                                                t._element.style.top.slice(
                                                  0,
                                                  -2,
                                                ),
                                              )
                                              ...
                                              e.startsWith('RIGHT')
                                                ...
                                                : null !==
                                                  ...
                                                  a > window.innerWidth - o &&
                                                    (r =
                                                      window.innerWidth - o)),
                                              (t._element.style.left =
                                                ''.concat(r, 'px')),
                                              (t._element.style.top = ''.concat(
                                                i,
                                                'px',
                                              )),
                                              t._options.onDragging &&
                                      ...
                                      this._register(
                                        He(this._element, Ne, function (n) {
                                          n.preventDefault(),
                                            (t.offsetX =
                                              n.clientX -
                                              t._element.offsetLeft),
                                            (t.offsetY =
                                              n.clientY - t._element.offsetTop),
                                            t._draggableService.startDrag(
                                              t._element,
                                            ),
                                            (e.style.opacity = '0.6')
                                        }),
                                ...
                                },
                                {
                                  ...
                                  value: function (t, e) {
                                    ...
                                    if (
                                      ...
                                      return on.UNKNOWN
                                    var i =
                                      this._draggableService.dragContext
                                        .mouseMotionVector
                                    if (qe.RIGHT === r) {
                                      if (e === on.LEFT_TOP) return on.TOP_LEFT
                                      if (e === on.LEFT && i === qe.RIGHT)
                                        return on.RIGHT
                                      if (e === on.LEFT_BOTTOM)
                                        return on.BOTTOM_LEFT
                                    } else if (qe.LEFT === r) {
                                      if (e === on.RIGHT_TOP)
                                        return on.TOP_RIGHT
                                      if (e === on.RIGHT && i === qe.LEFT)
                                        return on.LEFT
                                      if (e === on.RIGHT_BOTTOM)
                                        return on.BOTTOM_RIGHT
                                    } else if (qe.DOWN === r) {
                                      if (e === on.TOP_LEFT) return on.LEFT_TOP
                                      if (e === on.TOP && i === qe.DOWN)
                                        return on.BOTTOM
                                      if (e === on.TOP_RIGHT)
                                        return on.RIGHT_TOP
                                    } else if (qe.UP === r) {
                                      if (e === on.BOTTOM_LEFT)
                                        return on.LEFT_BOTTOM
                                      if (e === on.BOTTOM && i === qe.UP)
                                        return on.TOP
                                      if (e === on.BOTTOM_RIGHT)
                                        return on.RIGHT_BOTTOM
                                    }
                                    return on.UNKNOWN
                                  },
                                },
          ...
          un =
            Ae()(
              ($e =
                (function (t, e) {
                  return nn(rn.FrameContent)(t, void 0, 0)
                })(
                  ($e =
                    Reflect.metadata(
                      'design:type',
                              ...
                              ve()(n, [
                                {
                                  ...
                                  value: function (t) {
                                    ...
                                    return (
                                      e.classList.add(
                                        'devtool-frame-container',
                                      ),
                                      n.classList.add('devtool-frame'),
                                      e.appendChild(n),
                                      (e.style.width =
                                        'min(80vw, 100vw - '.concat(
                                          2 * this._margin,
                                          'px)',
                                        )),
                                      (e.style.height =
                                        'min(70vh, 100vh - '.concat(
                                          2 * this._margin,
                                          'px)',
                                        )),
                                      t.container && t.container.appendChild(e),
                                ...
                                },
                                {
                                  ...
                                  value: function () {
                                    ;(this._visible = !this._visible),
                                      this._visible
                                        ? this._frameElement.classList.add(
                                            'opened',
                                          )
                                        : this._frameElement.classList.remove(
                                            'opened',
                                          )
                                  },
                                },
          ...
          fn =
            Ae()(
              (tn =
                (function (t, e) {
                  return nn(rn.Panel)(t, void 0, 0)
                })(
                  (tn =
                    (function (t, e) {
                      return nn(rn.Frame)(t, void 0, 1)
                    })(
                      (tn =
                        Reflect.metadata(
                          'design:type',
        ...
        function hn() {
          return (
            en ||
            ((en = new ue({ skipBaseClassChecks: !0 }))
              .bind(rn.DraggableService)
              .to(Ve)
              .inSingletonScope(),
            en.bind(rn.Panel).to(an),
            en.bind(rn.Frame).to(un),
            en.bind(rn.FrameContent).to(sn),
            en.bind(rn.Workbench).to(fn),
            en)
          )
        }
      })(),
